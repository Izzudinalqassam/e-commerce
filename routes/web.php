...
Route::middleware(['auth', AuthAdmin::class])->group(function () {
    ...
    Route::get('admin/product/edit/{id}', [AdminController::class, 'products_edit'])->name('admin.product.edit');
    Route::put('admin/product/update/{id}', [AdminController::class, 'products_update'])->name('admin.product.update');
    Route::delete('admin/product/delete/{id}', [AdminController::class, 'products_delete'])->name('admin.product.delete');
});
